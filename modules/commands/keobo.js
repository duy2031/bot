...
if(!args[0] || isNaN(args[0])){
   ...
   if (await checkMoney(senderID, 1000) == false){return api.sendMessage('𝐘𝐞̂𝐮 𝐜𝐚̂̀𝐮 𝐛𝐚̣𝐧 𝐜𝐚̂̀𝐧 𝐜𝐨́ 𝐢́𝐭 𝐧𝐡𝐚̂́𝐭 1000 𝐧𝐞̂́𝐮 𝐦𝐮𝐨̂́𝐧 𝐭𝐡𝐚𝐦 𝐠𝐢𝐚 𝐤𝐞́𝐨 𝐛𝐨̀ 🐮', threadID, messageID)}
